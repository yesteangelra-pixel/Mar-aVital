...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "María Vital · Tu distribuidor doTERRA de confianza" },
      { property: "og:description", content: "Tu tienda doTERRA y bienestar holístico. Aceites esenciales puros, asesoría y formaciones." },
    ],
  }),
  component: Home,
});
